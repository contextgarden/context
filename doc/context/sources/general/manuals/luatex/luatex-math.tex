...
The keyword \type {norule} will hide the rule with the \type {\above} variants
while keeping the rule related spacing.
...
\typ {\mathscriptcharmode}, \typ {\mathdefaultsmode},
...
% The \typ {\mathflattenmode} primitive is also considered obsolete (HH) but
% has been reactivated because \LATEX\ depends on it.
