...
By default paragraphs before a display equation containing dir nodes are never 
ignored. Changing that could break existing documents, but when you set \lpr 
{mathemptydisplaymode} to~\type {1} empty paragraphs before a display equation 
will be ignored.
