...
The engine has quite some libraries built in of which some are discussed in
...
modules because we delegate as much as possible to \LUA. This means that some
rather specific libraries have little to offer to users, because they are
supposed to be hooked in for instance \METAPOST, or more accurate, \LUAMETAFUN\
related features. This also means that we don't need to document them because
that kind of happens in their application. Of course we can let methods evolve
as we go forward.
...
\startcombination[nx=5,ny=1,distance=2em]
    {\dm{\ctxlua{vector.typeset(document.v44)}}} {\hbox{\tt 4 × 4}}
    {\dm{\ctxlua{vector.typeset(document.v14)}}} {\hbox{\tt 1 × 4}}
    {\dm{\ctxlua{vector.typeset(document.v41)}}} {\hbox{\tt 4 × 1}}
    {\dm{\ctxlua{vector.typeset(document.v22)}}} {\hbox{\tt 2 × 2}}
    {\dm{\ctxlua{vector.typeset(document.v33)}}} {\hbox{\tt 3 × 3}}
\stopcombination
\stoplinecorrection
...
\startcombination[nx=4,ny=1,distance=2em]
    {\dm{\ctxlua{vector.typeset(document.v44   )}}} {}
    {\dm{\ctxlua{vector.typeset(document.vdemo1)}}} {\hbox{\tt 4 ×}}
    {\dm{\ctxlua{vector.typeset(document.vdemo2)}}} {\hbox{\tt × 4}}
    {\dm{\ctxlua{vector.typeset(document.vdemo3)}}} {\hbox{\tt ×  }}
\stopcombination
\stoplinecorrection
...
\startcombination[nx=2,ny=3,distance=2em]
  {\dm{\ctxlua{vector.typeset(document.v1)}}} {} {\hbox{\tt \cldcontext{tostring(document.v1)}}} {}
  {\dm{\ctxlua{vector.typeset(document.v2)}}} {} {\hbox{\tt \cldcontext{tostring(document.v2)}}} {}
  {\dm{\ctxlua{vector.typeset(document.v3)}}} {} {\hbox{\tt \cldcontext{tostring(document.v3)}}} {}
\stopcombination
\stoplinecorrection
...
\startlinecorrection
\startcombination[nx=4,ny=1,distance=2em]
  {\dm{\ctxlua{vector.typeset(document.v22   )}}} {}
  {\dm{\ctxlua{vector.typeset(document.vdemo1)}}} {\hbox{\type {round}}}
  {\dm{\ctxlua{vector.typeset(document.vdemo2)}}} {\hbox{\type {floor}}}
  {\dm{\ctxlua{vector.typeset(document.vdemo3)}}} {\hbox{\type {ceiling}}}
\stopcombination
\stoplinecorrection
...
\startcombination[nx=3,ny=1,distance=2em]
  {\dm{\ctxlua{vector.typeset(document.vdemo1)}}} {\hbox{\type {3 × 3}}}
  {\dm{\ctxlua{vector.typeset(document.vdemo2)}}} {\hbox{\type {4 × 4}}}
  {\dm{\ctxlua{vector.typeset(document.vdemo3)}}} {\hbox{\type {2 × 2}}}
\stopcombination
\stoplinecorrection
...
\startcombination[nx=6,ny=1,distance=2em]
    {\dm{\ctxlua{vector.typeset(document.v44   )}}} {}
    {\dm{\ctxlua{vector.typeset(document.vdemo1)}}} {\hbox{\tt transpose}}
    {\dm{\ctxlua{vector.typeset(document.v41   )}}} {}
    {\dm{\ctxlua{vector.typeset(document.vdemo2)}}} {\hbox{\tt swap}}
    {\dm{\ctxlua{vector.typeset(document.v14   )}}} {}
    {\dm{\ctxlua{vector.typeset(document.vdemo3)}}} {\hbox{\tt swap}}
\stopcombination
\stoplinecorrection
...
\startlinecorrection
\startcombination[nx=5,ny=1,distance=2em]
    {\dm{\ctxlua{vector.typeset(document.v33   )}}}              {\hbox {v33}}
    {\dm{\ctxlua{vector.typeset(document.vdemo1)}}}              {\hbox {inverse}}
    {\dm{\ctxlua{vector.typeset(document.vdemo1*document.v33)}}} {\hbox {verified}}
    {\dm{\ctxlua{vector.typeset(document.vdemo2)}}}              {\hbox {row echelon}}
    {\dm{\ctxlua{vector.typeset(document.vdemo3)}}}              {\hbox {reduced echelon}}
\stopcombination
\stoplinecorrection
...
\startlinecorrection
\startcombination[nx=3,ny=1,distance=2em]
    {\dm{\ctxlua{vector.typeset(document.v33   )}}} {}
    {\dm{\ctxlua{vector.typeset(document.vdemo1)}}} {}
    {\dm{\ctxlua{vector.typeset(document.vdemo2)}}} {}
\stopcombination
\stoplinecorrection
...
\startcombination[nx=2,ny=1,distance=2em]
    {\dm{\ctxlua{vector.typeset(document.vdemo0, { template = 8 } )}}} {}
    {\dm{\ctxlua{vector.typeset(document.vdemo1, { template = 3 } )}}} {}
\stopcombination
\stoplinecorrection
...
\startlinecorrection
\startcombination[nx=2,ny=1,distance=2em]
    {\dm{\ctxlua{vector.typeset(document.num0)}}} {}
    {\dm{\ctxlua{vector.typeset(document.num1)}}} {}
\stopcombination
\stoplinecorrection
...
\startlinecorrection
\startcombination[nx=2,ny=1,distance=2em]
    {\dm{\ctxlua{vector.typeset(document.cvec0)}}} {}
    {\dm{\ctxlua{vector.typeset(document.cvec1)}}} {}
\stopcombination
\stoplinecorrection
...
\startlinecorrection
\startcombination[nx=4,ny=1,distance=2em]
    {\dm{\ctxlua{vector.typeset(document.vdemo0)}}} {}
    {\dm{\ctxlua{vector.typeset(document.vdemo1)}}} {}
    {\dm{\ctxlua{vector.typeset(document.vdemo2)}}} {}
    {\dm{\ctxlua{vector.typeset(document.vdemo3)}}} {}
\stopcombination
\stoplinecorrection
...
\startcombination[nx=7,ny=1,distance=2em]
    ...
    {\dm{\ctxlua{vector.typeset(document.vdemo2)}}} {}
    {\dm{\ctxlua{vector.typeset(document.vdemo3)}}} {}
    {\dm{\ctxlua{vector.typeset(document.vdemo4)}}} {}
\stopcombination
\stoplinecorrection
...
\startcombination[nx=4,ny=1,distance=2em]
    {\dm{\ctxlua{vector.typeset(document.vdemo0)}}}   {}
    {\dm{\ctxlua{vector.typeset(document.vdemo0r)}}}  {}
    {\dm{\ctxlua{vector.typeset(document.vdemo0c)}}}  {}
    {\dm{\ctxlua{vector.typeset(document.vdemo0rc)}}} {}
\stopcombination
\stoplinecorrection
...
\startcombination[nx=5,ny=1,distance=2em]
    ...
    {\dm{\ctxlua{vector.typeset(document.vdemo3)}}} {}
    {\dm{\ctxlua{vector.typeset(document.vdemo4)}}} {}
    {\dm{\ctxlua{vector.typeset(document.vdemo5)}}} {}
\stopcombination
\stoplinecorrection
...
\startlinecorrection
\startcombination[nx=4,ny=1,distance=2em]
    {\dm{\ctxlua{vector.typeset(document.v1t1)}}} {\type{v t}}
    {\dm{\ctxlua{vector.typeset(document.t1v1)}}} {\type{t v}}
    {\dm{\ctxlua{vector.typeset(document.v1v2)}}} {\type{v v}}
    {\dm{\ctxlua{vector.typeset(document.t1t2)}}} {\type{t t}}
\stopcombination
\stoplinecorrection
