...
Here follows a list with all primitives and their internal classification. When
the engine starts up in ini mode all primitives get defined along with some
