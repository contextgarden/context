...
See \prm {Uover} for an introduction.
...
{\em todo} \writestatus{TODO}{\string\Udelcode}

\stopnewprimitive

\startnewprimitive[title={\prm {Udelimited}}]

{\em todo} \writestatus{TODO}{\string\Udelimited}

\stopnewprimitive

\startnewprimitive[title={\prm {Udelimiter}}]

{\em todo} \writestatus{TODO}{\string\Udelimiter}

\stopnewprimitive

\startnewprimitive[title={\prm {Udelimiterover}}]

{\em todo} \writestatus{TODO}{\string\Udelimiterover}

\stopnewprimitive

\startnewprimitive[title={\prm {Udelimiterunder}}]

{\em todo} \writestatus{TODO}{\string\Udelimiterunder}

\stopnewprimitive

\startnewprimitive[title={\prm {Uhextensible}}]

{\em todo} \writestatus{TODO}{\string\Uhextensible}

\stopnewprimitive

\startnewprimitive[title={\prm {Uleft}}]

This command is combined with \prm {Umiddle}, which is optional, and \prm
{Uright}, which is mandate, although we are tolerant and do some checking. As in
traditional \TEX's \prm {left} and \prm {right} and \ETEX's \prm {middle} these
fences bound a sub formula and adapt their heights. They are one of the reasons
why rendering math is a multi-pass affair: we first have to calculate the inner
sizes in order to decide on the outer fences.

Although it might nor be clear from the names, \prm {Uoperator} and \prm
{Uvextensible} use the same fencing mechanism. All of these \type {U} commands
accept options. Not all options are applied to every fence, at least not now.
Some in the end makes little sense but were part of experiments, so we kept them.

\starttabulate[|Tl|l|l|]
\NC attr       \NC integer integer \NC \NC \NR
\NC auto       \NC                 \NC \NC \NR
\NC axis       \NC                 \NC \NC \NR
\NC bottom     \NC dimension       \NC \NC \NR
\NC class      \NC integer         \NC \NC \NR
\NC depth      \NC dimension       \NC \NC \NR
\NC exact      \NC                 \NC \NC \NR
\NC factor     \NC integer         \NC \NC \NR
\NC height     \NC dimension       \NC \NC \NR
\NC leftclass  \NC integer         \NC \NC \NR
\NC limits     \NC                 \NC \NC \NR
\NC noaxis     \NC                 \NC \NC \NR
\NC nocheck    \NC                 \NC \NC \NR
\NC nolimits   \NC                 \NC \NC \NR
\NC nooverflow \NC                 \NC \NC \NR
\NC middle     \NC                 \NC \NC \NR
\NC phantom    \NC                 \NC \NC \NR
\NC rightclass \NC integer         \NC \NC \NR
\NC scale      \NC                 \NC \NC \NR
\NC single     \NC                 \NC \NC \NR
\NC source     \NC integer         \NC \NC \NR
\NC symbolattr \NC integer integer \NC \NC \NR
\NC top        \NC dimension       \NC \NC \NR
\NC usecallback\NC                 \NC \NC \NR
\NC variant    \NC integer         \NC \NC \NR
\NC void       \NC                 \NC \NC \NR
\stoptabulate

In due time more explanation will be added here. The usage is straightforward so
when no options are given we can do:
...
{\em todo} \writestatus{TODO}{\string\Umathaccent}

% \startbuffer
% \im {\Umathaccent top "1 "0 `A {xxx}}
% \stopbuffer
...
\NC attr        \NC integer integer                               \NC \NC \NR
\NC base        \NC                                               \NC \NC \NR
\NC bottom      \NC \type {[fixed]} <char>                        \NC \NC \NR
\NC both        \NC \type {[fixed]} <char> \type {[fixed]} <char> \NC \NC \NR
\NC center      \NC                                               \NC \NC \NR
\NC class       \NC integer                                       \NC \NC \NR
\NC exact       \NC                                               \NC \NC \NR
\NC fraction    \NC integer                                       \NC \NC \NR
\NC fixed       \NC char                                          \NC \NC \NR
\NC keepbase    \NC                                               \NC \NC \NR
\NC nooverflow  \NC                                               \NC \NC \NR
\NC overlay     \NC\type {[fixed]} char                           \NC \NC \NR
\NC shrink      \NC                                               \NC \NC \NR
\NC single      \NC                                               \NC \NC \NR
\NC source      \NC integer                                       \NC \NC \NR
\NC stretch     \NC                                               \NC \NC \NR
\NC symbolattr  \NC integer integer                               \NC \NC \NR
\NC top         \NC \type {[fixed]} char                          \NC \NC \NR
\NC usecallback \NC                                               \NC \NC \NR
\stoptabulate
...
% \im {\Umathaccent top fixed "0 "0 "0302             {xxxxxxxx}}
...
% \im {\Umathaccent overlay          "0 "0 "0302             {xxxxxxxx}}
% \im {\Umathaccent base overlay          "0 "0 "0302             {xxxxxxxx}}
% \im {\Umathaccent nooverflow top       "0 "0 "0302             {xxxxxxxx}}
% \im {\Umathaccent fraction 123  top       "0 "0 "0302             {xxxxxxxx}}
% \stopbuffer
...
{\em todo} \writestatus{TODO}{\string\Umathaccentbasedepth}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathaccentbaseheight}}]

{\em todo} \writestatus{TODO}{\string\Umathaccentbaseheight}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathaccentbottomovershoot}}]

{\em todo} \writestatus{TODO}{\string\Umathaccentbottomovershoot}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathaccentbottomshiftdown}}]

{\em todo} \writestatus{TODO}{\string\Umathaccentbottomshiftdown}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathaccentextendmargin}}]

{\em todo} \writestatus{TODO}{\string\Umathaccentextendmargin}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathaccentsuperscriptdrop}}]

{\em todo} \writestatus{TODO}{\string\Umathaccentsuperscriptdrop}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathaccentsuperscriptpercent}}]

{\em todo} \writestatus{TODO}{\string\Umathaccentsuperscriptpercent}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathaccenttopovershoot}}]

{\em todo} \writestatus{TODO}{\string\Umathaccenttopovershoot}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathaccenttopshiftup}}]

{\em todo} \writestatus{TODO}{\string\Umathaccenttopshiftup}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathaccentvariant}}]

The current value of this parameter is \CurrentMathVariant \Umathaccentvariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathadapttoleft}}]

{\em todo} \writestatus{TODO}{\string\Umathadapttoleft}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathadapttoright}}]

{\em todo} \writestatus{TODO}{\string\Umathadapttoright}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathaxis}}]

{\em todo} \writestatus{TODO}{\string\Umathaxis}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathbottomaccentvariant}}]

The current value of this parameter is \CurrentMathVariant \Umathbottomaccentvariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathchar}}]

{\em todo} \writestatus{TODO}{\string\Umathchar}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathchardef}}]

{\em todo} \writestatus{TODO}{\string\Umathchardef}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathcode}}]

{\em todo} \writestatus{TODO}{\string\Umathcode}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathconnectoroverlapmin}}]

{\em todo} \writestatus{TODO}{\string\Umathconnectoroverlapmin}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathdegreevariant}}]

The current value of this parameter is \CurrentMathVariant \Umathdegreevariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathdelimiterextendmargin}}]

{\em todo} \writestatus{TODO}{\string\Umathdelimiterextendmargin}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathdelimiterovervariant}}]

The current value of this parameter is \CurrentMathVariant \Umathdelimiterovervariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathdelimiterpercent}}]

{\em todo} \writestatus{TODO}{\string\Umathdelimiterpercent}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathdelimitershortfall}}]

{\em todo} \writestatus{TODO}{\string\Umathdelimitershortfall}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathdelimiterundervariant}}]

The current value of this parameter is \CurrentMathVariant \Umathdelimiterundervariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathdenominatorvariant}}]

The current value of this parameter is \CurrentMathVariant \Umathdenominatorvariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathdictdef}}]

{\em todo} \writestatus{TODO}{\string\Umathdictdef}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathexheight}}]

{\em todo} \writestatus{TODO}{\string\Umathexheight}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathextrasubpreshift}}]

{\em todo} \writestatus{TODO}{\string\Umathextrasubpreshift}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathextrasubprespace}}]

{\em todo} \writestatus{TODO}{\string\Umathextrasubprespace}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathextrasubshift}}]

{\em todo} \writestatus{TODO}{\string\Umathextrasubshift}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathextrasubspace}}]

{\em todo} \writestatus{TODO}{\string\Umathextrasubspace}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathextrasuppreshift}}]

{\em todo} \writestatus{TODO}{\string\Umathextrasuppreshift}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathextrasupprespace}}]

{\em todo} \writestatus{TODO}{\string\Umathextrasupprespace}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathextrasupshift}}]

{\em todo} \writestatus{TODO}{\string\Umathextrasupshift}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathextrasupspace}}]

{\em todo} \writestatus{TODO}{\string\Umathextrasupspace}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathflattenedaccentbasedepth}}]

{\em todo} \writestatus{TODO}{\string\Umathflattenedaccentbasedepth}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathflattenedaccentbaseheight}}]

{\em todo} \writestatus{TODO}{\string\Umathflattenedaccentbaseheight}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathflattenedaccentbottomshiftdown}}]

{\em todo} \writestatus{TODO}{\string\Umathflattenedaccentbottomshiftdown}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathflattenedaccenttopshiftup}}]

{\em todo} \writestatus{TODO}{\string\Umathflattenedaccenttopshiftup}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathfractiondelsize}}]

{\em todo} \writestatus{TODO}{\string\Umathfractiondelsize}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathfractiondenomdown}}]

{\em todo} \writestatus{TODO}{\string\Umathfractiondenomdown}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathfractiondenomvgap}}]

{\em todo} \writestatus{TODO}{\string\Umathfractiondenomvgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathfractionnumup}}]

{\em todo} \writestatus{TODO}{\string\Umathfractionnumup}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathfractionnumvgap}}]

{\em todo} \writestatus{TODO}{\string\Umathfractionnumvgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathfractionrule}}]

{\em todo} \writestatus{TODO}{\string\Umathfractionrule}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathfractionvariant}}]

The current value of this parameter is \CurrentMathVariant \Umathfractionvariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathhextensiblevariant}}]

The current value of this parameter is \CurrentMathVariant \Umathhextensiblevariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathlimitabovebgap}}]

{\em todo} \writestatus{TODO}{\string\Umathlimitabovebgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathlimitabovekern}}]

{\em todo} \writestatus{TODO}{\string\Umathlimitabovekern}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathlimitabovevgap}}]

{\em todo} \writestatus{TODO}{\string\Umathlimitabovevgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathlimitbelowbgap}}]

{\em todo} \writestatus{TODO}{\string\Umathlimitbelowbgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathlimitbelowkern}}]

{\em todo} \writestatus{TODO}{\string\Umathlimitbelowkern}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathlimitbelowvgap}}]

{\em todo} \writestatus{TODO}{\string\Umathlimitbelowvgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathlimits}}]

{\em todo} \writestatus{TODO}{\string\Umathlimits}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathnoaxis}}]

{\em todo} \writestatus{TODO}{\string\Umathnoaxis}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathnolimits}}]

{\em todo} \writestatus{TODO}{\string\Umathnolimits}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathnolimitsubfactor}}]

{\em todo} \writestatus{TODO}{\string\Umathnolimitsubfactor}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathnolimitsupfactor}}]

{\em todo} \writestatus{TODO}{\string\Umathnolimitsupfactor}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathnumeratorvariant}}]

The current value of this parameter is \CurrentMathVariant \Umathnumeratorvariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathopenupdepth}}]

{\em todo} \writestatus{TODO}{\string\Umathopenupdepth}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathopenupheight}}]

{\em todo} \writestatus{TODO}{\string\Umathopenupheight}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathoperatorsize}}]

{\em todo} \writestatus{TODO}{\string\Umathoperatorsize}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathoverbarkern}}]

{\em todo} \writestatus{TODO}{\string\Umathoverbarkern}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathoverbarrule}}]

{\em todo} \writestatus{TODO}{\string\Umathoverbarrule}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathoverbarvgap}}]

{\em todo} \writestatus{TODO}{\string\Umathoverbarvgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathoverdelimiterbgap}}]

{\em todo} \writestatus{TODO}{\string\Umathoverdelimiterbgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathoverdelimitervariant}}]

The current value of this parameter is \CurrentMathVariant \Umathoverdelimitervariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathoverdelimitervgap}}]

{\em todo} \writestatus{TODO}{\string\Umathoverdelimitervgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathoverlayaccentvariant}}]

The current value of this parameter is \CurrentMathVariant \Umathoverlayaccentvariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathoverlinevariant}}]

The current value of this parameter is \CurrentMathVariant \Umathoverlinevariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathphantom}}]

{\em todo} \writestatus{TODO}{\string\Umathphantom}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathprimeraise}}]

{\em todo} \writestatus{TODO}{\string\Umathprimeraise}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathprimeraisecomposed}}]

{\em todo} \writestatus{TODO}{\string\Umathprimeraisecomposed}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathprimeshiftdrop}}]

{\em todo} \writestatus{TODO}{\string\Umathprimeshiftdrop}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathprimeshiftup}}]

{\em todo} \writestatus{TODO}{\string\Umathprimeshiftup}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathprimespaceafter}}]

{\em todo} \writestatus{TODO}{\string\Umathprimespaceafter}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathprimevariant}}]

The current value of this parameter is \CurrentMathVariant \Umathprimevariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathquad}}]

{\em todo} \writestatus{TODO}{\string\Umathquad}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathradicaldegreeafter}}]

{\em todo} \writestatus{TODO}{\string\Umathradicaldegreeafter}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathradicaldegreebefore}}]

{\em todo} \writestatus{TODO}{\string\Umathradicaldegreebefore}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathradicaldegreeraise}}]

{\em todo} \writestatus{TODO}{\string\Umathradicaldegreeraise}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathradicalextensibleafter}}]

{\em todo} \writestatus{TODO}{\string\Umathradicalextensibleafter}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathradicalextensiblebefore}}]

{\em todo} \writestatus{TODO}{\string\Umathradicalextensiblebefore}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathradicalkern}}]

{\em todo} \writestatus{TODO}{\string\Umathradicalkern}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathradicalrule}}]

{\em todo} \writestatus{TODO}{\string\Umathradicalrule}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathradicalvariant}}]

The current value of this parameter is \CurrentMathVariant \Umathradicalvariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathradicalvgap}}]

{\em todo} \writestatus{TODO}{\string\Umathradicalvgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathruledepth}}]

{\em todo} \writestatus{TODO}{\string\Umathruledepth}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathruleheight}}]

{\em todo} \writestatus{TODO}{\string\Umathruleheight}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathskeweddelimitertolerance}}]

{\em todo} \writestatus{TODO}{\string\Umathskeweddelimitertolerance}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathskewedfractionhgap}}]

{\em todo} \writestatus{TODO}{\string\Umathskewedfractionhgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathskewedfractionvgap}}]

{\em todo} \writestatus{TODO}{\string\Umathskewedfractionvgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathsource}}]

{\em todo} \writestatus{TODO}{\string\Umathsource}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathspaceafterscript}}]

{\em todo} \writestatus{TODO}{\string\Umathspaceafterscript}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathspacebeforescript}}]

{\em todo} \writestatus{TODO}{\string\Umathspacebeforescript}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathspacebetweenscript}}]

{\em todo} \writestatus{TODO}{\string\Umathspacebetweenscript}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathstackdenomdown}}]

{\em todo} \writestatus{TODO}{\string\Umathstackdenomdown}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathstacknumup}}]

{\em todo} \writestatus{TODO}{\string\Umathstacknumup}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathstackvariant}}]

The current value of this parameter is \CurrentMathVariant \Umathstackvariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathstackvgap}}]

{\em todo} \writestatus{TODO}{\string\Umathstackvgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathsubscriptsnap}}]

{\em todo} \writestatus{TODO}{\string\Umathsubscriptsnap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathsubscriptvariant}}]

The current value of this parameter is \CurrentMathVariant \Umathsubscriptvariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathsubshiftdown}}]

{\em todo} \writestatus{TODO}{\string\Umathsubshiftdown}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathsubshiftdrop}}]

{\em todo} \writestatus{TODO}{\string\Umathsubshiftdrop}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathsubsupshiftdown}}]

{\em todo} \writestatus{TODO}{\string\Umathsubsupshiftdown}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathsubsupvgap}}]

{\em todo} \writestatus{TODO}{\string\Umathsubsupvgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathsubtopmax}}]

{\em todo} \writestatus{TODO}{\string\Umathsubtopmax}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathsupbottommin}}]

{\em todo} \writestatus{TODO}{\string\Umathsupbottommin}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathsuperscriptsnap}}]

{\em todo} \writestatus{TODO}{\string\Umathsuperscriptsnap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathsuperscriptvariant}}]

The current value of this parameter is \CurrentMathVariant \Umathsuperscriptvariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathsupshiftdrop}}]

{\em todo} \writestatus{TODO}{\string\Umathsupshiftdrop}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathsupshiftup}}]

{\em todo} \writestatus{TODO}{\string\Umathsupshiftup}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathsupsubbottommax}}]

{\em todo} \writestatus{TODO}{\string\Umathsupsubbottommax}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathtopaccentvariant}}]

The current value of this parameter is \CurrentMathVariant \Umathtopaccentvariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathunderbarkern}}]

{\em todo} \writestatus{TODO}{\string\Umathunderbarkern}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathunderbarrule}}]

{\em todo} \writestatus{TODO}{\string\Umathunderbarrule}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathunderbarvgap}}]

{\em todo} \writestatus{TODO}{\string\Umathunderbarvgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathunderdelimiterbgap}}]

{\em todo} \writestatus{TODO}{\string\Umathunderdelimiterbgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathunderdelimitervariant}}]

The current value of this parameter is \CurrentMathVariant \Umathunderdelimitervariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathunderdelimitervgap}}]

{\em todo} \writestatus{TODO}{\string\Umathunderdelimitervgap}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathunderlinevariant}}]

The current value of this parameter is \CurrentMathVariant \Umathunderlinevariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathuseaxis}}]

{\em todo} \writestatus{TODO}{\string\Umathuseaxis}

\stopnewprimitive

\startnewprimitive[title={\prm {Umathvextensiblevariant}}]

The current value of this parameter is \CurrentMathVariant \Umathvextensiblevariant.

\stopnewprimitive

\startnewprimitive[title={\prm {Umathvoid}}]

{\em todo} \writestatus{TODO}{\string\Umathvoid}
...
See \prm {Uleft} for an explanation.

\stopnewprimitive

\startnewprimitive[title={\prm {Uoperator}}]

{\em todo} \writestatus{TODO}{\string\Uoperator}

\stopnewprimitive

\startnewprimitive[title={\prm {Uover}}]

This command is one of the fraction constructors. \footnote {The traditional
commands like \prm {over}, \prm {atop} and \prm {above} are supported but in for
instance \CONTEXT\ they are disabled or have different meanings.} A fraction has
a numerator and a denominator and optionally a rule in between. Another option is
left and right fences. You might wonder why this feature is there instead of
using regular left and right fences and the reason is (but I can be mistaken) in
spacing: here the open|/|close spacing doesn't apply, which makes sense if you
take the application in mind: binominals, in which case we have what looks like a
fraction, without rule but with for instance parentheses.

Here we show the six more or less traditional vertically stacked variants of
fractions. Watch how we have a syntax where we take two arguments instead of the
more operator like approach that \prm {over} and friends use. The \type {atop}
variants have no rule. So we have:

\starttabulate[|l|lT|lT|lT|l|]
    \NC \type{\Uabove}     \NC   \NC 1pt \NC \type {{1} {2+x}} \NC \im{\showglyphs \Uabove       1pt{1}{2+x}}
    \NC \type{\Uatop}      \NC   \NC     \NC \type {{1} {2+x}} \NC \im{\showglyphs \Uatop           {1}{2+x}}
    \NC \type{\Uover}      \NC   \NC     \NC \type {{1} {2+x}} \NC \im{\showglyphs \Uover           {1}{2+x}}
    \NC \type{\Uskewed}    \NC / \NC     \NC \type {{1} {2+x}} \NC \im{\showglyphs \Uskewed    /    {1}{2+x}}
    \NC \type{\Ustretched} \NC = \NC     \NC \type {{1} {2+x}} \NC \im{\showglyphs \Ustretched =    {1}{2+x}}
\stoptabulate

versus:

\starttabulate[|l|lT|lT|lT|lT|l|]
    \NC \type{\Uabovewithdelims}     \NC   \NC () \NC 1pt \NC \type {{1} {2+x}} \NC \im{\showglyphs \Uabovewithdelims      ()1pt{1}{2+x}} \NC \NR \TB[medium]
    \NC \type{\Uatopwithdelims}      \NC   \NC () \NC     \NC \type {{1} {2+x}} \NC \im{\showglyphs \Uatopwithdelims       ()   {1}{2+x}} \NC \NR \TB[medium]
    \NC \type{\Uoverwithdelims}      \NC   \NC () \NC     \NC \type {{1} {2+x}} \NC \im{\showglyphs \Uoverwithdelims       ()   {1}{2+x}} \NC \NR \TB[medium]
    \NC \type{\Uskewedwithdelims}    \NC / \NC () \NC     \NC \type {{1} {2+x}} \NC \im{\showglyphs \Uskewedwithdelims    /()   {1}{2+x}} \NC \NR \TB[medium]
    \NC \type{\Ustretchedwithdelims} \NC = \NC () \NC     \NC \type {{1} {2+x}} \NC \im{\showglyphs \Ustretchedwithdelims =()   {1}{2+x}} \NC \NR
\stoptabulate

The relative positioning (like the gap above or below a rule) is partly
determined by math font parameters but there are additional ways to influence the
look and feel with options.

\starttabulate[|Tl|l|l|]
\NC attr         \NC integer integer \NC \NC \NR
\NC class        \NC integer         \NC \NC \NR
\NC exact        \NC                 \NC reserved, not used \NC \NR
\NC font         \NC                 \NC use font related thickness \NC \NR
\NC hfactor      \NC integer         \NC \NC \NR
\NC noaxis       \NC                 \NC \NC \NR
\NC nooverflow   \NC                 \NC \NC \NR
\NC proportional \NC                 \NC reserved, not used \NC \NR
\NC style        \NC integer or id   \NC \NC \NR
\NC source       \NC integer         \NC \NC \NR
\NC symbolattr   \NC integer integer \NC \NC \NR
\NC thickness    \NC dimension       \NC \NC \NR
\NC usecallback  \NC                 \NC \NC \NR
\NC vfactor      \NC integer         \NC \NC \NR
\stoptabulate

Not all apply to every fraction but it made sense to just accept all. When the
\type {thickness} is specified, scanning the formal dimension skipped. In due
time these options will be discussed in mode detail.

\stopnewprimitive

\startnewprimitive[title={\prm {Uoverdelimiter}}]

{\em todo} \writestatus{TODO}{\string\Uoverdelimiter}
...
{\em todo} \writestatus{TODO}{\string\Uradical}
...
{\em todo} \writestatus{TODO}{\string\Uroot}

\stopnewprimitive

\startnewprimitive[title={\prm {Urooted}}]

{\em todo} \writestatus{TODO}{\string\Urooted}
...
This is equivalent to the first of a pair of \type {$$}.
...
This is equivalent to the second of a pair of \type {$$}.
...
This command is the companion of \prm {Ustartmathmode}.
...
{\em todo} \writestatus{TODO}{\string\Uunderdelimiter}

\stopnewprimitive

\startnewprimitive[title={\prm {Uvextensible}}]

{\em todo} \writestatus{TODO}{\string\Uvextensible}
...
\startnewprimitive[title={\prm {alignloop}}]

This is just a convenient (and more clear) variant of the double tab: \typ
{\aligntab \aligntab} or \type {&&} when that method is used.
...
\startnewprimitive[title={\prm {alignoption}}]

This is an experimental feature that accepts some of the keywords that one can
pass to the alignment command: \typ {firstskip}, \typ {lastskip}, \typ
{nofirstskip}, \typ {nolastskip} and \type {prune}. When given in a cell they
will overload the already set options.

\stopnewprimitive

\startnewprimitive[title={\prm {alignsnapping}}]

This primitive is part of the experimental line snapping mechanism and when set
determines how rows get snapped.
...
\startnewprimitive[title={\prm {attributeboundary}}]

This creates a boundary node with two properties that can be picked up at the
\LUA\ end: \type {data} and \type {reserved}; after all we had that second
field anyway so why now exploit it.
...
\startnewprimitive[title={\prm {boxsnapping}}]

This is an experimental feature what we occasionally come back to, so it's
...
\startnewprimitive[title={\prm {breaklasthangindent}}]

This variable reflects the state of the current vertical list with respect to
a \prm {hangindent} and \prm {hangafter} situation.

\stopnewprimitive

\startnewprimitive[title={\prm {breaklasthangleftindent}}]

This variable reflects the state of the current vertical list with respect to a
(positive, therefore left) \prm {localhangindent} and \prm {localhangafter}
situation.

\stopnewprimitive

\startnewprimitive[title={\prm {breaklasthangleftslack}}]

This variable reflects the state of the current vertical list with respect to a
(positive, therefore left) \prm {localhangindent} and \prm {localhangafter}
situation. Here slack refers to the pending number lines on the left.

\stopnewprimitive

\startnewprimitive[title={\prm {breaklasthangrightindent}}]

This variable reflects the state of the current vertical list with respect to a
(negative, therefore right) \prm {localhangindent} and \prm {localhangafter}
situation.

\stopnewprimitive

\startnewprimitive[title={\prm {breaklasthangrightslack}}]

This variable reflects the state of the current vertical list with respect to a
(negative, therefore right) \prm {localhangindent} and \prm {localhangafter}
situation. Here slack refers to the pending number lines on the right.

\stopnewprimitive

\startnewprimitive[title={\prm {breaklasthangslack}}]

This variable reflects the state of the current vertical list with respect to a
\prm {hangindent} and \prm {hangafter} situation. Here slack refers to the
pending number lines.

\stopnewprimitive

\startnewprimitive[title={\prm {breaklastlinecount}}]

This variable refers to the current vertical list.

\stopnewprimitive

\startnewprimitive[title={\prm {breaklastlinewidth}}]
...
\startnewprimitive[title={\prm {currentalignmentcolumn}}]

This number keeps track of the current column.

\stopnewprimitive

\startnewprimitive[title={\prm {currentalignmentrow}}]

This number keeps track of the current row.

\stopnewprimitive

\startnewprimitive[title={\prm {currentalignmenttabskip}}]
...
This is the most extensive of the triplet \prm {dimexpr}, \prm {dimexpression}
and and \prm {dimexperimental}. The first one is the simple \ETEX\ scanner, the
second one adds a few more operators and the third one adds even more and uses a
reverse polish notation stack internally which means that it is better with
priorities and nesting. The reason for calling it experimental is that it needs
testing an dis less of a drop-in than the second one.

For more about this scanner we refer to the \CONTEXT\ lowlevel manuals,
especially the one about expressions..
...
An empty display math environment can add bogus nodes to the list. Although we
don't use the engine's display math in \CONTEXT, we do support this parameter
because it permitted us to test a comparable feature in \LUATEX. In our case the
value is a bitmap:

\startcolumns[n=2]
\getbuffer[engine:syntax:emptyparagraphmodevalues]
\stopcolumns
...
\startnewprimitive[title={\prm {errorrecoverymode}}]

There are cases when an error is not fatal and \TEX\ can easily recover from it.
It does not mean that one should not pay attention. This parameter gets a bitset
that makes the engine turn these errors into warnings and continue. Currently we
have two options: 0x01 for fixing an alignment tab, and 0x02 for fixing infinite
shrink (which happens in various places). We don't enable this in \CONTEXT; it's
more for unattended runs.
...
\startnewprimitive[title={\prm {everyparbegin}}]

This token list is inserted {\em before} \prm {everypar} and likewise it's not
reset.

\stopnewprimitive

\startnewprimitive[title={\prm {everyparend}}]

This token lists is injected at the end of a paragraph but before collected end
of group tokens. This register is not reset afterwards.
...
This parameter is like \prm {exhyphenchar} marks a character code as being an
explicit apostrophe. This feature related to the \type {node.direct.collapsing}
function that turns replaces some sequences that relate to traditional \TEX\
usage: hyphens, en-dashes (\type {U+2013}), em-dashes (\type {U+2014}) and
apostrophes (\type {U+2019}). For this to kick in, the font's text control option
must enable it and hyphenation mode must have the replace apostrophe bit set.
...
a space (and leading spaces in a line are normally being ignored anyway).
...
\startnewprimitive[title={\prm {fontcharlb}}]

This command returns the left-bottom math kern of a glyph. These kerns are set
by \CONTEXT font goodies and more reliable than the OPENTYPE\ staircase kerns.

\stopnewprimitive

\startnewprimitive[title={\prm {fontcharlt}}]

This command returns the left-top math kern of a glyph.

\stopnewprimitive

\startnewprimitive[title={\prm {fontcharrb}}]

This command returns the right-bottom math kern of a glyph.

\stopnewprimitive

\startnewprimitive[title={\prm {fontcharrt}}]
...
The various leaders differ in how they anchor and align the successive
components:
...
\NC \type {nolastskip} \NC remove the last \prm {tabskip} \NC \NR
\LL
\stoptabulate
...
Here is an example of \typ {nolastskip} usage:
...
\startnewprimitive[title={\prm {ifspecification}}]

This test expects a specification (more extensive data structures) and goes
\quote {true} when it is a valid one. This primitive might evolved a bit.
...
\startnewprimitive[title={\prm {ignoretokens}}]

This primitive is an input command that reads a balanced list and discards what
it sees upto a matching right brace.
...
\startnewprimitive[title={\prm {insertboundary}}]

This boundary takes two integer values. When it is encountered in the page
builder a callback \typ {insert_boundary} will be triggered that gets the two
...
\startnewprimitive[title={\prm {insertcategory}}]

There is currently only one category (0x01) for page bound inserts like
footnotes. The category is used to help determining the top of an insert stack as
well as the first in a substack. For instance, a top insert can come before a
footnote but in that case the first footnote is still the first in the list of
inserts with the same category (when set). This relates to the \type
{insert_distance} callback where the first variant call gets an index (integer),
variant (here 1), a first and top state (boolean) and returns a distance (glue).
These are rather specialized features.
...
\startnewprimitive[title={\prm {insertmaxplaced}}]

This represents the maximum number of inserts that gets placed (flushed) for the
given index.
...
\startnewprimitive[title={\prm {insertonlycount}}]
...
\startnewprimitive[title={\prm {insertoptions}}]

When bit 0x01 is set, the engine will check for insert overflows as described in
one of the \quote {beyond} wrap-ups in the \CONTEXT\ distribution. Such overflows
can happen in documents (like critical editions) that have many (large) notes
that end up on their own pages.
...
\startnewprimitive[title={\prm {insertplaced}}]

This quantity hold the number of inserts in a specific class that has been
placed, assuming that we use that insert mode.
...
\startnewprimitive[title={\prm {justificationskip}}]

When set, the amount is added to the left- and/or right skip values and the
stretch and shrink properties then replace the corresponding fields in those
skips. This feature relates to experimental support for ragged paragraphs.
...
\startnewprimitive[title={\prm {lastalignmentcolumn}}]

This number keeps track of the last (maximum) column count.

\stopnewprimitive

\startnewprimitive[title={\prm {lastalignmentrow}}]
...
% % \startnewprimitive[title={\prm {lastlinecount}}]
% %
% % This state variable holds the most recent number of lines in a paragraph broken
% % into lines.
% %
% % \stopnewprimitive
...
% % \startnewprimitive[title={\prm {lastlinewidth}}]
% %
% % This state variable holds the width of the last line in the most recently
% % paragraph broken into lines.
% %
% % \stopnewprimitive
...
\startnewprimitive[title={\prm {linesnapping}}]

This is an experimental feature what we occasionally come back to, so it's
currently undocumented. Here is an example definition:
...
Here the height and depth are multipliers then themselves get multiplied by \prm
{linesnappinghtfactor} and \prm {linesnappingdpfactor} and applied to the \prm
{baselineskip}. More details can be found in the \CONTEXT\ documentation.

\stopnewprimitive

\startnewprimitive[title={\prm {linesnappingdpfactor}}]

See \prm {linesnapping}.

\stopnewprimitive

\startnewprimitive[title={\prm {linesnappinghtfactor}}]

See \prm {linesnapping}.

\stopnewprimitive

\startnewprimitive[title={\prm {linesnappingtolerance}}]
...
\startnewprimitive[title={\prm {localhangafter}}]

A positive value will create a local, that is at he current line, hole in the
paragraph similar to a \prm {hangafter}. One needs to set \prm {localhangindent}
in order to happen. Depending on the sign of that dimension the hole will appear
left or right. In this perspective \quote {current} is a bit fluid because the
par builder is in charge of breaking lines at the best possible location.

\stopnewprimitive

\startnewprimitive[title={\prm {localhangindent}}]

This value only kicks in when a \prm {localhangafter} command is given. A
positive dimension will create an insert left of the paragraph, a negative
number creates a hole at the right. This is consistent with \prm {hangindent}.
...
\FL
\NC ordinary        \NC ord    \NC \the\mathordinarycode    \NC the default \NC \NR
...
\NC active          \NC        \NC \the\mathactivecode      \NC character marked as such becomes active \NC \NR
\NC inner           \NC        \NC \the\mathinnercode       \NC this class is not possible for characters \NC \NR
\ML
...
The math renderer can set some options in the process and these are kept with the
result in the math nodes. The snapping options in this set can be controlled by
the user. The engine itself doesn't anything with these.

\startcolumns[n=2]
\getbuffer[engine:syntax:mathoptions]
\stopcolumns
...
\startnewprimitive[title={\prm {mathsnapping}}]

This parameter relates to \prm {linesnapping} and is applied to (inline) math.
...
\startnewprimitive[title={\prm {notexpanded}}]

This is an equivalent of \type {\unexpanded} which happens to be a \CONTEXT\
prefix (the pre-\ETEX\ equivalent of \prm {protected}). It permits us to
transition to a regular primitive with the benefits that comes with primitives,
line overload protection, syntax highlighting, etc.
...
Where \prm {numexpr} (from \ETEX) only does simple addition, subtraction,
multiplication and division, \prm {numexpression} does some more. A next step in
functionality is provided by \prm {numexperimental}. That one is discussed in
more detail in the the \CONTEXT\ lowlevel manual about expressions.
...
% \startnewprimitive[title={\prm {optionspar}}]
% \stopnewprimitive
...
\startnewprimitive[title={\prm {parfillmode}}]

This mode configures native ragged left and right justification: left 1, right 2,
middle 3.
...
% \startnewprimitive[title={\prm {prerollmvl}}]
% \stopnewprimitive
...
in that mode. Characters (glyphs) and rules force horizontal mode but for
instance boxes will take a whole line when they start a paragraph.
...
\startnewprimitive[title={\prm {scaledfontcharlb}}]

This command returns the left-bottom math kern of a glyph. scaled according to
\prm {glyphscale} and \prm {glyphxscale}. These kerns are set by \CONTEXT font
goodies and more reliable than the OPENTYPE\ staircase kerns.

\stopnewprimitive

\startnewprimitive[title={\prm {scaledfontcharlt}}]

See \prm {scaledfontcharlb}, here we return the left-top kern.

\stopnewprimitive

\startnewprimitive[title={\prm {scaledfontcharrb}}]

See \prm {scaledfontcharlb}, here we return the right-bottom kern.

\stopnewprimitive

\startnewprimitive[title={\prm {scaledfontcharrt}}]

See \prm {scaledfontcharlb}, here we return the right-top kern.
...
{glyphyscale}. Valid (text font) dimension are:

\starttabulate[|c|l|]
\BC \# \BC font dimension    \NC \NR
\NC 1  \NC slant per point   \NC \NR
\NC 2  \NC interword space   \NC \NR
\NC 3  \NC interword stretch \NC \NR
\NC 4  \NC interword shrink  \NC \NR
\NC 5  \NC ex height         \NC \NR
\NC 6  \NC em width          \NC \NR
\NC 7  \NC extra space       \NC \NR
\stoptabulate

Some traditional \TEX\ fonts provide more and math fonts also have
plenty although in \OPENTYPE\ all is different.

\stopnewprimitive

\startnewprimitive[title={\prm {scaledfontemwidth}}]

This primitive takes a font identifier and returns the em width
scaled by the current glyph scales.

\stopnewprimitive

\startnewprimitive[title={\prm {scaledfontexheight}}]

This primitive takes a font identifier and returns the ex height
scaled by the current glyph scales.

\stopnewprimitive

\startnewprimitive[title={\prm {scaledfontextraspace}}]

This primitive takes a font identifier and returns the extra space
property scaled by the current glyph scales.

\stopnewprimitive

\startnewprimitive[title={\prm {scaledfontinterwordshrink}}]

This primitive takes a font identifier and returns the shrink
component of a space scaled by the current glyph scales.

\stopnewprimitive

\startnewprimitive[title={\prm {scaledfontinterwordspace}}]

This primitive takes a font identifier and returns the fixed
component of a space scaled by the current glyph scales.

\stopnewprimitive

\startnewprimitive[title={\prm {scaledfontinterwordstretch}}]

This primitive takes a font identifier and returns the stretch
component of a space scaled by the current glyph scales.

\stopnewprimitive

\startnewprimitive[title={\prm {scaledfontslantperpoint}}]

This primitive takes a font identifier and (normally only for an italic font)
returns the slant scaled by the current glyph scales.
...
\startnewprimitive[title={\prm {spaceskipfactor}}]

This is a multiplier, with the usual 1000 meaning 1.000, that get applied to the
amount, stretch and shrink components of space glue. It is mostly there for
demonstration purposes, and usually giving it a value other that 1000 gives less
optimal results.

\stopnewprimitive

\startnewprimitive[title={\prm {spaceskipmode}}]

Space skip refers to specific spacing after for instance punctuation. A bitset
determines what components of the glue are ignored: amount (1), stretch (2),
shrink (4).
...
\startoldprimitive[title={\prm {spcode}}]

This is a variation on \prm {sfcode} and it works in combination with the \prm {textspacing}
feature. The code relates a character to a category, like:
...
After this \typ {\textspacing \nonpenalizedspacingmap} will enable this mapping.
When not set the usual \prm {sfcode}'s will be used.

\stopoldprimitive

\startnewprimitive[title={\prm {specificationcount}}]

See \in {section} [specifications] for more about specifications. This primitive returns
an integer indicating how many entries the specification has.
...
\startnewprimitive[title={\prm {specificationfirst}}]

See \in {section} [specifications] for more about specifications. This primitive returns
an integer or dimension.
...
\startnewprimitive[title={\prm {specificationoptions}}]
...
\startnewprimitive[title={\prm {specificationsecond}}]
...
\startnewprimitive[title={\prm {textspacing}}]

This sets a text spacing vectors that determine space factors and penalties per
category; see \prm {spcode}.

\stopnewprimitive

\startnewprimitive[title={\prm {textspacingfactor}}]

This primitive reports the spacing factor of the given character code.

\stopnewprimitive

\startnewprimitive[title={\prm {textspacingpenalty}}]
...
This one is somewhat special: it limits the precision to 5 digits which is
what \TEX\ at most will give you. Here are some examples:
...
You'll notice that accuracy is far from perfect which has to do
with the fact that at some point for instance large integers have
to be mapped onto a double.
...
Fortunately we seldom have weird numbers in a \TEX\ run, so the
results are maybe sub-optimal but seldom so extreme because a \TEX\
integer fits into a double.
...
% \startnewprimitive[title={\prm {tracingraggedness}}]
% \stopnewprimitive
...
\startnewprimitive[title={\prm {tracingsnapping}}]
...
original form, assuming that \prm {vbalanceddeinsert} was applied.. This is not
...
% This needs to be checked because some was added.
