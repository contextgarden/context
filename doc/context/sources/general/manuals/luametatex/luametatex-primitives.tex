...
variants have no rule.

\starttabulate[|l|lT|lT|lT|lT|i1l|i2l|lT|lT|lT|lT|i1l|]
    \NC \type{\Uabove}               \NC   \NC    \NC 1pt \NC \type {{1} {2+x}} \NC \im{\showglyphs \Uabove                  1pt{1}{2+x}}
    \NC \type{\Uabovewithdelims}     \NC   \NC () \NC 1pt \NC \type {{1} {2+x}} \NC \im{\showglyphs \Uabovewithdelims      ()1pt{1}{2+x}} \NC \NR \TB[medium]
    \NC \type{\Uatop}                \NC   \NC    \NC     \NC \type {{1} {2+x}} \NC \im{\showglyphs \Uatop                      {1}{2+x}}
    \NC \type{\Uatopwithdelims}      \NC   \NC () \NC     \NC \type {{1} {2+x}} \NC \im{\showglyphs \Uatopwithdelims       ()   {1}{2+x}} \NC \NR \TB[medium]
    \NC \type{\Uover}                \NC   \NC    \NC     \NC \type {{1} {2+x}} \NC \im{\showglyphs \Uover                      {1}{2+x}}
    \NC \type{\Uoverwithdelims}      \NC   \NC () \NC     \NC \type {{1} {2+x}} \NC \im{\showglyphs \Uoverwithdelims       ()   {1}{2+x}} \NC \NR \TB[medium]
    \NC \type{\Uskewed}              \NC / \NC    \NC     \NC \type {{1} {2+x}} \NC \im{\showglyphs \Uskewed              /     {1}{2+x}}
    \NC \type{\Uskewedwithdelims}    \NC / \NC () \NC     \NC \type {{1} {2+x}} \NC \im{\showglyphs \Uskewedwithdelims    /()   {1}{2+x}} \NC \NR \TB[medium]
    \NC \type{\Ustretched}           \NC = \NC    \NC     \NC \type {{1} {2+x}} \NC \im{\showglyphs \Ustretched           =     {1}{2+x}}
