...
interpreted. In \CONTEXT\ we keep this value zero!
...
The results are collected in a box (in this exmaple box register 2) which destroys the
original. With
...
{forcedepth} will make sure that we get constent depths (but expects \prm
