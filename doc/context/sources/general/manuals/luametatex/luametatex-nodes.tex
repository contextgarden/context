...
% common : function node.direct.flushnode

% list : function node.direct.getanchors
% list : function node.direct.getbox
% list : function node.direct.setbox

% list : function node.direct.getnormalizedline

% attributes : function node.direct.unsetattributes
% attributes : function node.direct.patchattributes
% attributes : function node.direct.getusedattributes
% attributes : function node.direct.currentattributes
...
% general : function node.direct.getnodes

% function node.direct.ignoremathskip

% (unprotected)

% function node.direct.ischar (n, font, data )
% function node.direct.ischar (n, font, data, state )
% function node.direct.ischar (n, font, scale, xscale, yscale )
% function node.direct.ischar (n, font, data, scale, xscale, yscale )
...
% function node.direct.issimilarglyph   (a, b) font data scales slant weight
% function node.direct.firstitalicglyph (n, checkkerntoo)
...
% function node.direct.getcurrenttail
% function node.direct.setcurrenttail
% function node.direct.appendcurrenttail
% function node.direct.prependcurrenttail
% function node.direct.insertcurrenthead
...
Of course this one is also available in the \typ {node.direct} namespace, as is
