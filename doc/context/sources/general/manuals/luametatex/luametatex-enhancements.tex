...
The last checked values are available in \prm {lastchknumber} and \prm
{lastchkdimension}. These don't obey grouping.

The two primitives \prm {ifchkdimension} and \prm {ifchknumber} are like \prm
{ifchkdim} and \prm {ifchknum} but are more rigorous: the short ones quit
...
makes sense (for integers). The \type {;} can used to get the remainder.
