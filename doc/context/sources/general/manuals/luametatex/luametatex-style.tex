...
\ifdefined \luametatexverboseversion \else
    \permanent\def\luametatexverboseversion{\cldcontext{environment.luatexverbose}}
    \permanent\def\luametatexfunctionality {\cldcontext{environment.luatexfunctionality}}
\fi
...
\tolerant\protected\def\showenginevalues[#1]#*#:#2%
  {\startenginesubject[title={#2}]
     \startcolumns[n=\ifparameter#1\or#1\else2\fi]
...
\tolerant\protected\def\showenginefields[#1]#*#:#2%
  {\startenginesubject[title=fields]
     \startcolumns[n=\ifparameter#1\or#1\else3\fi]
