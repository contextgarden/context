...
although in \CONTEXT\ we use \typ {\ignoredepthcriterium} instead of the hard
...
In this example we set \typ {\ignoredepthcriterium} to $\tf -50.0pt$ instead of the
...
\typ {\ignoredepthcriterium} being $\tf 50pt$.
