...
There are some datastructures that are like arrays: \prm {brokenpenalties}, \prm
{clubpenalties}, \prm {displaywidowpenalties}, \prm {fitnessdemerits}, \prm
{interlinepenalties}, \prm {mathbackwardpenalties}, \prm {mathforwardpenalties},
\prm {orphanpenalties}, \prm {parpasses}, \prm {parshape} and \prm
{widowpenalties}. They accept a counter than tells how many entries follow and
depending in the specification options, keywords and|/|or just values are
expected.
