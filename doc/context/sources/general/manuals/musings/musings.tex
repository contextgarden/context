...
\startbodymatter
  ...
  % \component musings-cheats
    ...
    \component musings-kerns          % article
    \component musings-deserved       % probably article
    \component musings-riscv
    \component musings-features       % article
    \component musings-shift
  % \component musings-neat           % article
    \component musings-illiterate     % article
    \component musings-fake
    \component musings-rpi

  % \component musings-basic          % stand-alone
\stopbodymatter
