...
the path we already mentioned. There should be a file there called \typ
...
At the end of the \typ {SciteGlobal.properties} you need to add the following
line:
...
can fetch them from \typ {http://dejavu-fonts.org} as well. You have to copy
...
\typ {scite-ctx-templates.lua}. You can put a similar file in your working path or one or two
