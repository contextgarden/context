...
/*tex
    ...
    Todo: the ps backend is also not needed but it's mixed up with reading
    font files so hard to avoid.
...
# define GMP_VERSION_STRING    "GMP NOT AVAILABLE"
# define PNG_LIBPNG_VER_STRING "PNG NOT AVAILABLE"
# define ZLIB_VERSION          "ZLIB NOT AVAILABLE";
...
const char * const COMPILED_gmp_version    = GMP_VERSION_STRING;

char png_libpng_ver[] = "PNG NOT AVAILABLE";

# define zlibVersion() "ZLIB NOT AVAILABLE";
