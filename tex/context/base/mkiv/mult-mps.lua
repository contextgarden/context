return {
    ...
    primitives = {
        ...
        "firstpoint", "firstprecontrol", "firstpostcontrol", "firstdirection", "firstunitdirection",
        ...
        "deltaprecontrol", "deltapostcontrol", "deltadirection", "deltaunitdirection", "arclength",
        ...
        "pathstate", "precontrol", "postcontrol", "direction", "unitdirection", "pathpoint", "pathprecontrol",
        "pathxpart", "pathypart", "pathpostcontrol", "pathdirection", "pathunitdirection", "penoffset", "arctime",
        "arcpoint", "arcpointlist", "subarclength", "mpversion", "rotated", "slanted",
        "scaled", "shifted", "xshifted", "yshifted", "transformed", "xscaled", "yscaled", "zscaled", "xyscaled",
    ...
    commands = {
     ...
     -- "center",
        "directionpoint", "unitdirectionpoint", "div", "dotprod", "intersectionpoint", "inverse", "mod",
        ...
        "blankpicture",
        "counterclockwise", "tensepath", "takepower",
        "softjoin", -- "magstep",
        "makelabel", -- "laboff",
