...
local blocks = allocate {
 ...
 -- ["digitstibetan"]                               = { first = 0x00F20, last = 0x00F29, math = true },
    ...
    ["egyptianhieroglyphsextendeda"]                = { first = 0x13460, last = 0x143FF,              description = "Egyptian Hieroglyphs Extended-A" },
    ...
    ["garay"]                                       = { first = 0x10D40, last = 0x10D8F,              description = "Garay" },
    ...
    ["gurungkhema"]                                 = { first = 0x16100, last = 0x1613F,              description = "Gurung Khema" },
    ...
    ["kiratrai"]                                    = { first = 0x16D40, last = 0x16D7F,              description = "Kirat Rai" },
    ...
    ["myanmarextendedc"]                            = { first = 0x116D0, last = 0x116FF,              description = "Myanmar Extended-C" },
    ...
    ["olonal"]                                      = { first = 0x1E5D0, last = 0x1E5FF,              description = "Ol Onal" },
    ...
    ["sunuwar"]                                     = { first = 0x11BC0, last = 0x11BFF,              description = "Sunuwar" },
    ...
    ["symbolsforlegacycomputingsupplement"]         = { first = 0x1CC00, last = 0x1CEBF,              description = "Symbols for Legacy Computing Supplement" },
